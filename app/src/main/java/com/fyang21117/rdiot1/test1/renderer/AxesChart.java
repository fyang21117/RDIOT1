...
import com.fyang21117.rdiot1.test1.common.IFormatterDoubleCallBack;
import com.fyang21117.rdiot1.test1.renderer.axis.CategoryAxis;
import com.fyang21117.rdiot1.test1.renderer.axis.CategoryAxisRender;
import com.fyang21117.rdiot1.test1.renderer.axis.DataAxis;
import com.fyang21117.rdiot1.test1.renderer.axis.DataAxisRender;
import com.fyang21117.rdiot1.test1.renderer.info.PlotAxisTick;
import com.fyang21117.rdiot1.test1.renderer.plot.AxisTitle;
import com.fyang21117.rdiot1.test1.renderer.plot.AxisTitleRender;
...
public class AxesChart extends EventChart {
	...
	public AxesChart() {
		...
		if(null == mLstDataTick)    mLstDataTick = new  ArrayList<>();
		if(null == mLstCateTick)    mLstCateTick = new  ArrayList<>();
									 ...
									 ArrayList<PlotAxisTick> lstLabels)
	{
		...
		for(int i=0;i<lstLabels.size();i++) 
		{
			...
			{				 
				...
				case RIGHT:			
				case VERTICAL_CENTER:
						dataAxis.renderAxisHorizontalTick(this.getLeft(),
                                                            this.getPlotArea().getLeft(),
