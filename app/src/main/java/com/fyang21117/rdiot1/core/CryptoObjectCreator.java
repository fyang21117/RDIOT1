package com.fyang21117.rdiot1.core;
...
import com.fyang21117.rdiot1.log.FPLog;
...
public class CryptoObjectCreator {
    ...
    private FingerprintManager.CryptoObject mCryptoObject;//用于加密对象
    private KeyStore mKeyStore;//通过KeyStore非对称加密实现
    private KeyGenerator mKeyGenerator;//此类提供（对称）密钥生成器的功能。
    private Cipher mCipher;//解密和加密类
